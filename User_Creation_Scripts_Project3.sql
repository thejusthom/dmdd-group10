...
BEGIN
  ...
  EXECUTE IMMEDIATE 'GRANT SELECT,UPDATE ON doctor_information_view TO DOCTOR_ROLE';
  ...
  EXECUTE IMMEDIATE 'GRANT SELECT, INSERT, UPDATE, DELETE ON doctor_information_view TO ADMIN_ROLE';
  EXECUTE IMMEDIATE 'GRANT SELECT, INSERT, UPDATE, DELETE ON patient_information_view TO ADMIN_ROLE';
  EXECUTE IMMEDIATE 'GRANT SELECT, INSERT, UPDATE, DELETE ON appointment_information_view TO ADMIN_ROLE';
  EXECUTE IMMEDIATE 'GRANT SELECT, INSERT, UPDATE, DELETE ON blood_inventory_view TO ADMIN_ROLE';
  EXECUTE IMMEDIATE 'GRANT SELECT, INSERT, UPDATE, DELETE ON doctor_appointment_view TO ADMIN_ROLE';
  EXECUTE IMMEDIATE 'GRANT SELECT, INSERT, UPDATE, DELETE ON top_blood_donors_view TO ADMIN_ROLE';
